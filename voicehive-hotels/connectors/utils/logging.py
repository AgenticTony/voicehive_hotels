...
from .pii_redactor import PIIRedactorFilter
...
class ConnectorLogger:
    ...
    def debug(self, msg: str, **kwargs):
        ...
        self.logger.debug(
            msg, extra={"vendor": self.vendor, "hotel_id": self.hotel_id, **kwargs}
        )
    ...
    def error(self, msg: str, exc_info=None, **kwargs):
        ...
        self.logger.error(
            msg,
            exc_info=exc_info,
            extra={"vendor": self.vendor, "hotel_id": self.hotel_id, **kwargs},
        )
            ...
            try:
                ...
                if hasattr(self, "logger") and isinstance(self.logger, ConnectorLogger):
                    self.logger.log_api_call(
                        operation=operation, duration_ms=duration_ms, error=error
                    )
