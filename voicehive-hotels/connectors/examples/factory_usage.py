...
async def main():
    ...
    for vendor in vendors:
        ...
        print(
            f"  - {vendor}: {metadata.name} (v{metadata.version}) - {metadata.status.value}"
        )
    ...
    register_connector(
        ...
        ConnectorMetadata(
            ...
            capabilities={
                cap: True for cap in ["availability", "rates", "reservations"]
            },
            regions=["eu-west-1"],
