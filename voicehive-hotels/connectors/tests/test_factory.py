...
from connectors.contracts import PMSError, NotFoundError, MockConnector
...
class TestConnectorFactory:
    ...
    def test_config_validation(self):
        ...
        api_config = {"api_key": "test", "base_url": "test", "hotel_id": "test"}
    ...
    def test_instance_caching(self):
        ...
        config = {"api_key": "test", "base_url": "test", "hotel_id": "HOTEL01"}
...
class TestConvenienceFunctions:
    ...
    def test_get_connector(self):
        ...
        config = {"api_key": "test", "base_url": "test", "hotel_id": "test"}
