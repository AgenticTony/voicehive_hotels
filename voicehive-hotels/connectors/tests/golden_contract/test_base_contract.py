...
from connectors.contracts import (
    ...
    GuestProfile, ReservationDraft, ReservationPatch, BaseConnector
)
    ...
    def _get_test_config(self) -> Dict[str, Any]:
        ...
        if vendor == "apaleo":
            config.update({
                ...
                "client_secret": os.getenv("APALEO_TEST_CLIENT_SECRET", "test_secret"),
            })
        elif vendor == "mews":
            config.update({
...
def create_test_class(connector_class: Type[BaseConnector], config: Dict[str, Any] = None):
    """
    ...
    test_class = type(class_name, (GoldenContractTestBase,), {
